...
- Ensure the language is natural and easy for a farmer to understand.`;
        ...
        console.error(`Error analyzing ${cropType} disease with Vertex AI:`, error);
...
- Only decline if the question is completely unrelated to agriculture OR your capabilities (e.g., "Who is the president?", "Write code").`;
        ...
        console.error("Error in chatWithAI with Vertex AI:", error);
...
- Return arrays for recommendations, organicOptions, and perUnitList.`;
        ...
        const processedRecommendations = formatFertilizerText(parsedResult.recommendations || [], language);
        const processedOrganicOptions = formatFertilizerText(parsedResult.organicOptions || [], language);
        const processedPerUnitList = formatFertilizerText(parsedResult.perUnitList || [], language);
        ...
        console.error(`Error calculating fertilizer for ${cropType} with Vertex AI:`, error);
